...
using Nisus.Trade.Web.IdentityServer;

#if FEATURE_SIGNALR
using Nisus.Trade.Web.Owin;
using Abp.Owin;
...
namespace Nisus.Trade.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new Info { Title = "Trade API", Version = "v1" });
            ...
            return services.AddAbp<TradeWebHostModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "Trade API V1");
            }); //URL: /swagger
        }
        ...
        private static void ConfigureOwinServices(IAppBuilder app)
        {
            ...
            app.Properties["host.AppName"] = "Trade";

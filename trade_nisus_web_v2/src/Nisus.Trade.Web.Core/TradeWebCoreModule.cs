...
using Nisus.Trade.Web.Authentication.JwtBearer;
using Nisus.Trade.Web.Authentication.TwoFactor;
using Nisus.Trade.Web.Configuration;
#if FEATURE_SIGNALR
using Abp.Web.SignalR;
#endif

namespace Nisus.Trade.Web
{
    [DependsOn(
        typeof(TradeApplicationModule),
        typeof(TradeEntityFrameworkCoreModule),
    ...
    public class TradeWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public TradeWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(TradeApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TradeWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(TradeWebCoreModule).GetAssembly().GetDirectoryPathOrNull();

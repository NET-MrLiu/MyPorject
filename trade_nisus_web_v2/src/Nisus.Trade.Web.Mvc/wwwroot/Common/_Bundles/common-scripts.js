...
(function ($) {
    ...
    app.UserNotificationHelper = (function () {
        ...
        return function () {
            ...
            /* Example:
            abp.notifications.messageFormatters['Nisus.Trade.MyNotificationDataType'] = function(userNotification) {
...
(function () {
    ...
    var appLocalizationSource = abp.localization.getSource('Trade');

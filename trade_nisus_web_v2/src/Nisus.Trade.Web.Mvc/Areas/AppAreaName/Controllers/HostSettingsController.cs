...
using Nisus.Trade.Configuration.Host;
using Nisus.Trade.Editions;
using Nisus.Trade.Timing;
using Nisus.Trade.Timing.Dto;
using Nisus.Trade.Web.Areas.AppAreaName.Models.HostSettings;
...
namespace Nisus.Trade.Web.Areas.AppAreaName.Controllers
{
    ...
    public class HostSettingsController : TradeControllerBase
    {

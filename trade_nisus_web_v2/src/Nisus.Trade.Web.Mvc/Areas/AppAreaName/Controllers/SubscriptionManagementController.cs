...
using Nisus.Trade.Web.Areas.AppAreaName.Models.SubscriptionManagement;
using Nisus.Trade.Web.Controllers;
using Nisus.Trade.Web.Session;
using PaymentViewModel = Nisus.Trade.Web.Models.Payment.PaymentViewModel;

namespace Nisus.Trade.Web.Areas.AppAreaName.Controllers
{
    [Area("AppAreaName")]
    [AbpMvcAuthorize(AppPermissions.Pages_Administration_Tenant_SubscriptionManagement)]
    public class SubscriptionManagementController : TradeControllerBase
    {

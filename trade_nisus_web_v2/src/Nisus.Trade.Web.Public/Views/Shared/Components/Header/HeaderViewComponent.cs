...
using Nisus.Trade.Web.Public.Startup;
using Nisus.Trade.Web.Session;

namespace Nisus.Trade.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : TradeViewComponent
    {

...
namespace Nisus.Trade.Web.Public.Startup
{
    ...
    public class TradeWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public TradeWebFrontEndModule(IHostingEnvironment env, TradeEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TradeWebFrontEndModule).GetAssembly());
        }
    }
}

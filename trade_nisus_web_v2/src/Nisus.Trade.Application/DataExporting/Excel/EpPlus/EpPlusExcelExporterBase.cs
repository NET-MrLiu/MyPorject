...
using Nisus.Trade.Net.MimeTypes;
using OfficeOpenXml;

namespace Nisus.Trade.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : TradeServiceBase, ITransientDependency
    {

...
using Nisus.Trade.DemoUiComponents.Dto;

namespace Nisus.Trade.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : TradeAppServiceBase, IDemoUiComponentsAppService
    {

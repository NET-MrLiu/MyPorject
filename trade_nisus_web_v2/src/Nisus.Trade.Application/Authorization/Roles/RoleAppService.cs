...
using Nisus.Trade.Authorization.Permissions;
using Nisus.Trade.Authorization.Permissions.Dto;
using Nisus.Trade.Authorization.Roles.Dto;

namespace Nisus.Trade.Authorization.Roles
{
    /// <summary>
    /// Application service that is used by 'role management' page.
    /// </summary>
    [AbpAuthorize(AppPermissions.Pages_Administration_Roles)]
    public class RoleAppService : TradeAppServiceBase, IRoleAppService
    {

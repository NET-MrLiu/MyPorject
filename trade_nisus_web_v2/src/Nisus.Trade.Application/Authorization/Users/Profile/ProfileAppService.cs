...
using Nisus.Trade.Authorization.Users.Profile.Cache;
using Nisus.Trade.Authorization.Users.Profile.Dto;
using Nisus.Trade.Friendships;
using Nisus.Trade.Identity;
using Nisus.Trade.Security;
using Nisus.Trade.Storage;
using Nisus.Trade.Timing;

namespace Nisus.Trade.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : TradeAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Nisus.Trade",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Nisus.Trade",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }

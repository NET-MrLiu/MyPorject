...
namespace Nisus.Trade.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : TradeServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Nisus.Trade", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
